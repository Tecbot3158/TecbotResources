...
/**
 * 
 * Implemented 6 motor configuration by Javier Mondragon
 * 
...
public class RobotDrive implements MotorSafety {
  ...
  public enum MotorType {
    kFrontLeft(0), kFrontRight(1), kRearLeft(2), kRearRight(3), kMiddleLeft(4), kMiddleRight(5);
  ...
  /**
   * Constructor for RobotDrive with 6 motors specified with channel numbers. Set up parameters for
   * a four wheel drive system where all four motor pwm channels are specified in the call. This
   * call assumes Talons for controlling the motors.
   *
   * @param frontLeftMotor  Front left motor channel number
   ...
   * @param frontRightMotor Front right motor channel number
   * @param rearRightMotor  Rear Right motor channel number
   * @param middleRightMotor Middle motor channel number
   * @param middleLeftMotor  Middle motor channel number
   */
  public RobotDrive(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
                    final int rearRightMotor, final int middleLeftMotor, final int middleRightMotor) {
    m_sensitivity = kDefaultSensitivity;
    m_maxOutput = kDefaultMaxOutput;
    m_rearLeftMotor = new Talon(rearLeftMotor);
    m_rearRightMotor = new Talon(rearRightMotor);
    m_frontLeftMotor = new Talon(frontLeftMotor);
    m_frontRightMotor = new Talon(frontRightMotor);
    m_middleLeftMotor = new Talon(middleLeftMotor);
    m_middleRightMotor = new Talon(middleRightMotor);
    m_allocatedSpeedControllers = true;
    setupMotorSafety();
    drive(0, 0);
  }
  ...
  /**
   * Constructor for RobotDrive with 6 motors specified as SpeedController objects. Speed controller
   * input version of RobotDrive (see previous comments).
   *
   * @param frontLeftMotor  The front left SpeedController object used to drive the robot
   * @param rearLeftMotor   The back left SpeedController object used to drive the robot.
   * @param frontRightMotor The front right SpeedController object used to drive the robot.
   * @param rearRightMotor  The back right SpeedController object used to drive the robot.
   * @param middleLeftMotor   The middle SpeedController object used to drive the robot.
   * @param middleRightMotor The middle SpeedController object used to drive the robot.
   */
  public RobotDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
                    SpeedController frontRightMotor, SpeedController rearRightMotor, 
    ...
    m_frontRightMotor = requireNonNull(frontRightMotor, "frontRightMotor cannot be null");
    m_rearRightMotor = requireNonNull(rearRightMotor, "rearRightMotor cannot be null");
    m_middleLeftMotor = requireNonNull(middleLeftMotor, "middleLeftMotor cannot be null");
    m_middleRightMotor = requireNonNull(middleRightMotor, "middleRightMotor cannot be null");
    m_sensitivity = kDefaultSensitivity;
    m_maxOutput = kDefaultMaxOutput;
    m_allocatedSpeedControllers = false;
    setupMotorSafety();
  ...
  public void setInvertedMotor(MotorType motor, boolean isInverted) {
    switch (motor) {
      ...
      case kRearRight:
        ...
        break;
      case kMiddleRight:
          m_middleRightMotor.setInverted(isInverted);
          break;
      case kMiddleLeft:
          m_middleLeftMotor.setInverted(isInverted);
          break;
      default:
